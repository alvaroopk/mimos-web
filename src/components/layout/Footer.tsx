    ...
    <footer className="bg-primary-dark text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <p className="text-white/80 text-sm leading-relaxed">
              Centro Veterinario MIMOS. Cuidando mascotas en la zona norte de
              Murcia desde 2015.
            </p>
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-white/60">
          <p>&copy; 2026 Centro Veterinario MIMOS. Todos los derechos reservados.</p>
